...
def post_new():
    ...
    if request.method=='POST':
        ...
        db=get_db(); cur=db.cursor()
        cur.execute('INSERT INTO posts (title,author,content,ingredients,instructions,image_path) VALUES (?,?,?,?,?,?)', (title, author, content, ingredients, instructions, image_db_path))
